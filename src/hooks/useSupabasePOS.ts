      ...
      .on(
        ...
        (payload) => {
          const newProduct: Product = {
            ...
            costPrice: Number(payload.new.cost_price),
            sellPrice: Number(payload.new.sell_price),
            stock: payload.new.stock as number,
            code: (payload.new as any).code || undefined,
            barcode: payload.new.barcode as string | undefined,
            category: payload.new.category as string | undefined,
            isPhotocopy: payload.new.is_photocopy as boolean
          };
