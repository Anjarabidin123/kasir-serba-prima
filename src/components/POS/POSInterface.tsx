...
`;
  ...
  return (
    <div className="min-h-screen w-full bg-background">
      ...
      {/* Main Content Layout - Single Column for All Screens */}
      <div className="w-full px-2 sm:px-6 lg:px-8 py-2 sm:py-4">
        ...
        <Tabs value={currentTab} onValueChange={(value) => {
          ...
          <TabsList className="w-full grid grid-cols-4 gap-1 p-1 h-auto">
            <TabsTrigger value="pos" className="text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Kasir
            </TabsTrigger>
            <TabsTrigger value="quick-invoice" className="text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Nota Cepat
            </TabsTrigger>
            <TabsTrigger value="shopping-list" className="text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Daftar Belanja
            </TabsTrigger>
            <TabsTrigger value="stock" className="text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Stok
            </TabsTrigger>
            <TabsTrigger value="low-stock" className="text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Stok Menipis
            </TabsTrigger>
            <TabsTrigger value="receipt" className="text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Nota
            </TabsTrigger>
            <TabsTrigger value="reports" className="text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Laporan
            </TabsTrigger>
            <TabsTrigger value="admin" className="text-xs px-2 py-2 sm:text-sm sm:px-4 sm:py-3 rounded-md">
              Admin
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="pos" className="space-y-2 sm:space-y-4 mt-2 sm:mt-4">
            ...
            {/* Shopping Cart - Below Product List */}
            <div className="mt-4">
              <Suspense fallback={<ComponentLoader />}>
                <LazyShoppingCart
                  cart={cart}
